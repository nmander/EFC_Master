...
public class StatsTabRPMBinsFragment extends Fragment {
	...
	private BarData getData() {
		//float[] LifeTimeData =
/*		List<BarEntry> entries = new ArrayList<>();
		entries = new BarEntry(1500f, 1.1f));
		entries = new BarEntry(2000f, 2f));
		entries = new BarEntry(2500f, 2.5f));
		entries = new BarEntry(3000f, 85.3f));
		entries = new BarEntry(3500f, 12.7f));
		entries = new BarEntry(4000f, 8.6f));
		entries = new BarEntry(4500f, 2));
		entries = new BarEntry(5000f, 8.8f));
		entries = new BarEntry(5500f, 20.9f));
		entries = new BarEntry(6000f, 18.6f));
		entries = new BarEntry(6500f, 32f));
		entries = new BarEntry(7000f, 55.7f));
		entries = new BarEntry(7500f, 72.4f));
		entries = new BarEntry(8000f, 62.9f));
		entries = new BarEntry(8500f, 60.1f));
		entries = new BarEntry(9000f, 42.0f));
		entries = new BarEntry(9500f, 32.3f));
		entries = new BarEntry(10000f, 35f));
		entries = new BarEntry(10500f, 22.7f));
		entries = new BarEntry(11000f, 33.5f));
		entries = new BarEntry(11500f, 10.9f));*/
